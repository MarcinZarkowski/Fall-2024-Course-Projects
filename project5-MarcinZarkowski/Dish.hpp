 ...
 * 
 *The Dish class allows fro dish representation in the Virtual Bistro simulation. This file defines the Dish class and a struct called Ingredient used in the ingredients_ private variabls and 
