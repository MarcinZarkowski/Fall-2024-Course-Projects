/**
 * @file Dish.cpp
 * @brief This file contains the implementation of the Dish class in a virtual bistro simulation.
 * 
 *The Dish class allows fro dish representation in the Virtual Bistro simulation. This file implements setter and getter functions for the Dish class.
 *These functions are used to set and get the name, ingredients, prep time, price and cuisine type of the dish.
 * @date [11/1/2024]
...
//Implement Ingredient constructor
Ingredient::Ingredient(){
    name="UNKNOWN";
    quantity=0; // Quantity in stock
    required_quantity=0; // Quantity required for a dish
    price=0.00;
}

//Implement Ingredient paramaterized constructor
