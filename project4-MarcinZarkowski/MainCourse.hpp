/**
 * @file MainCourse.hpp
 * @brief This file contains the definition of the MainCourse class in a virtual bistro simulation.
 * 
 ...
 * Defines other get and set methods for the MainCourse class.
 * 
 * @date [10/25/2024]
...
public:
    ...
    */
    void dietaryAccommodations(DietaryRequest request) override;
