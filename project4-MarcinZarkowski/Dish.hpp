/**
 * @file Dish.hpp
 * @brief This file contains the definition of the Dish class in a virtual bistro simulation.
 * 
 *The Dish class is a Base class of Appetizer, MainCourse, Dessert classes in the virtual bistro. It is an abstract class and has 
 *pure virtual functions display and dietaryAccomidations.
 * 
 * @date [10/25/2024]
...
public:
    ...
    */
    virtual void dietaryAccommodations(Dish::DietaryRequest request) = 0;
