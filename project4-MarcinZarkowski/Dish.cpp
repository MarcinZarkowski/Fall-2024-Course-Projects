/**
 * @file Dish.hpp
 * @brief This file contains the implementations of the Dish class in a virtual bistro simulation.
 * 
 *The Dish class is a Base class of Appetizer, MainCourse, Dessert classes in the virtual bistro. It is an abstract class and implements 
