/**
 * @file Appetizer.hpp
 * @brief This file contains the definition of the Appetizer class in a virtual bistro simulation.
 * 
 ...
 * Defines other get and set methods for the Appetizer class.
 * 
 * @date [10/25/2024]
